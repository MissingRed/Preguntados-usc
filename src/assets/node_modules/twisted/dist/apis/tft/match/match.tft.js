...
class MatchTFTApi extends base_api_tft_1.BaseApiTft {
     ...
     * @param region
     */
    list(summonerPUUID, region) {
        return __awaiter(this, void 0, void 0, function* () {
            const params = {
                summonerPUUID
            };
            return this.request(region, endpoints_1.endpointsTFTV1.MatchListing, params);
        });
    }
    /**
     * Get match listing (with details)
     */
    listWithDetails(summonerPUUID, region) {
        return __awaiter(this, void 0, void 0, function* () {
            const params = {
                summonerPUUID
            };
            const response = [];
            // Match list
            const { response: ids } = yield this.request(region, endpoints_1.endpointsTFTV1.MatchListing, params);
            // Load details
            for (const id of ids) {
...
//# sourceMappingURL=match.tft.js.map